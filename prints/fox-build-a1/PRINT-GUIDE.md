> **Historical print record — superseded.** Use the [current guided-wire handle project](../../designs/guided-wire-handle/README.md) and [v2 head project](../fox-build-a1-head-v02/PRINT-GUIDE.md).
