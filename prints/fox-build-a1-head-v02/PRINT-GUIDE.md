...
This slice includes the reinforced cheek webs. Print only the five replacement head pieces. Use the current [guided-wire handle](../../designs/guided-wire-handle/README.md). An already assembled head does not need reprinting.

**Estimate: 33 minutes 33 seconds, 4.49 g of PLA.** Settings: A1, 0.4 mm nozzle, ordinary PLA, textured PEI, 0.16 mm layers (0.20 mm first), four walls, 50% gyroid, 2 mm outside brims, **supports disabled**. Nozzle 220 °C; bed 65 °C.
...
3. Review the preview and enable bed leveling. Leave timelapse off. Send the plate through Bambu Studio, or export the sliced G-code from the supplied 3MF to the printer's microSD card. Fox.Build documents both methods on its [A1 equipment page](https://fox.build/equipment/bambu-a1-3d-printers/).
